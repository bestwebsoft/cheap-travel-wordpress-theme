...
* The following images are used in the screenshot for the Theme
			https://pixabay.com/en/plane-trip-journey-wander-wonder-841441/
			https://pixabay.com/en/camera-travel-map-directions-867242/
			https://pixabay.com/en/mountains-nature-lake-sea-943780/
			https://pixabay.com/en/track-straight-line-path-outdoor-828649/
			https://pixabay.com/en/passport-travel-journey-trip-931882/
			License: CC0 Public Domain

Everything else used in this theme has been created by BestWebSoft, specifically for Cheap Travel theme, and is distributed under GPL license.
...
Cheap Travel WordPress theme supports only these post formats. Please style them in a certain way. Other post formats will be displayed as regular posts.
...
= V1.2 =
The theme has been tested for the compatibility with WordPress v.4.4.1.

= V1.1 =
Added site description. The following files were updated: style.css, header.php, footer.php, searchform.php, functions.php.

				...
				<div class="cheap-travel-footer container">
					<div class="cheap-travel-footer-content col-lg-12">
						<div class="cheap-travel-site-info">
							<p>
								<label class="cheap-travel-date-info">&copy;&nbsp;<?php echo date( 'Y' ) . '&nbsp;'; bloginfo( 'name' ); ?></label>
								<label class="cheap-travel-logo-info">
									<?php _e( 'Powered by', 'cheap-travel' ); ?>&nbsp;
									<a href="<?php echo esc_url( wp_get_theme()->get( 'AuthorURI' ) ); ?>" title="<?php esc_attr_e( 'Semantic Personal Publishing Platform', 'cheap-travel' ); ?>" target="_blank">BestWebSoft</a>
